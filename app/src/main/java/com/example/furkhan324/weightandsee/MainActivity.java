...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new LogsFragment(), "Log");
       adapter.addFragment(new AnalyticsFragment(), "Analytics");
       // adapter.addFragment(new MapFragment(), "hEat Map"); //custom concentration map
        adapter.addFragment(new SettingsFragment(), "Share");
